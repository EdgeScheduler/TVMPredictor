from create_dataset.common import uniform_sampling,generate_dataset_with_one_dimensionality_changing
import tvm.relay as relay
import create_dataset.test_code.op_test_code.run_channel.config.common_args as common_args
...
# # 限定shape
force_shape_relation=(None,(lambda x,y,z,m:x, lambda x,y,z,m:y, lambda x,y,z,m:z,lambda x,y,z,m:1))
