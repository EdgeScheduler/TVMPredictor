...
def calculate_op(dshape,dtype="float32"):
    ...
    f = relay.nn.dense(data=x,weight=y,units=None,out_dtype=dtype)

    return f

# 定义参数
function_dict = {"func":calculate_op, "name": "nn.dense"}


# 限定shape, tvm.relay.nn.dense目前存在bug，并不能支持复杂的输入形状
count = 7
force_shape_relation=(None,(None,lambda x,y:y))
shapes_dimensionality=((2,2),(0,0))
# range_min = ((-1,1),(1,1))
